...
static func build(
	...
	lobby_weapon_option.set_item_metadata(0, "ak47")
	lobby_weapon_option.add_item("Grenade")
	lobby_weapon_option.set_item_metadata(1, "grenade")
	lobby_weapon_option.add_item("KAR")
	lobby_weapon_option.set_item_metadata(2, "kar")
	lobby_weapon_option.add_item("Shotgun")
	lobby_weapon_option.set_item_metadata(3, "shotgun")
	lobby_weapon_option.add_item("Uzi")
	lobby_weapon_option.set_item_metadata(4, "uzi")

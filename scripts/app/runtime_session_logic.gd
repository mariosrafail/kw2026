...
func _setup_character_picker() -> void:
	...
	print("[DBG SETUP] Character picker: added Outrage (meta: %s), Erebus (meta: %s), Tasko (meta: %s), Juice (meta: %s), Madam (meta: %s), C3ll3r (meta: %s), Kotro (meta: %s), Nova (meta: %s), Hindi (meta: %s), Loker (meta: %s), Gan (meta: %s), Veila (meta: %s), Krog (meta: %s), Aevilok (meta: %s), Franky (meta: %s), Varn (meta: %s)" % [CHARACTER_ID_OUTRAGE, CHARACTER_ID_EREBUS, CHARACTER_ID_TASKO, CHARACTER_ID_JUICE, CHARACTER_ID_MADAM, CHARACTER_ID_CELLER, CHARACTER_ID_KOTRO, CHARACTER_ID_NOVA, CHARACTER_ID_HINDI, CHARACTER_ID_LOKER, CHARACTER_ID_GAN, CHARACTER_ID_VEILA, CHARACTER_ID_KROG, CHARACTER_ID_AEVILOK, CHARACTER_ID_FRANKY, CHARACTER_ID_VARN])

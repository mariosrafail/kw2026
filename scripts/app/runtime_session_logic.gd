...
func _setup_character_picker() -> void:
	...
	lobby_character_option.add_item("Agelikoula")
	lobby_character_option.set_item_metadata(19, CHARACTER_ID_AGELIKOULA)
	lobby_character_option.add_item("CrashOut")
	lobby_character_option.set_item_metadata(20, CHARACTER_ID_CRASHOUT)
	lobby_character_option.add_item("Ctrlalt")
	lobby_character_option.set_item_metadata(21, CHARACTER_ID_CTRLALT)
	print("[DBG SETUP] Character picker: added Outrage (meta: %s), Erebus (meta: %s), Tasko (meta: %s), Juice (meta: %s), Madam (meta: %s), C3ll3r (meta: %s), Kotro (meta: %s), Nova (meta: %s), Hindi (meta: %s), Loker (meta: %s), Gan (meta: %s), Veila (meta: %s), Krog (meta: %s), Aevilok (meta: %s), Franky (meta: %s), Varn (meta: %s), Lalou (meta: %s), M4 (meta: %s), Raining Pleasure (meta: %s), Agelikoula (meta: %s), CrashOut (meta: %s), Ctrlalt (meta: %s)" % [CHARACTER_ID_OUTRAGE, CHARACTER_ID_EREBUS, CHARACTER_ID_TASKO, CHARACTER_ID_JUICE, CHARACTER_ID_MADAM, CHARACTER_ID_CELLER, CHARACTER_ID_KOTRO, CHARACTER_ID_NOVA, CHARACTER_ID_HINDI, CHARACTER_ID_LOKER, CHARACTER_ID_GAN, CHARACTER_ID_VEILA, CHARACTER_ID_KROG, CHARACTER_ID_AEVILOK, CHARACTER_ID_FRANKY, CHARACTER_ID_VARN, CHARACTER_ID_LALOU, CHARACTER_ID_M4, CHARACTER_ID_RP, CHARACTER_ID_AGELIKOULA, CHARACTER_ID_CRASHOUT, CHARACTER_ID_CTRLALT])

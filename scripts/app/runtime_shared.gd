...
const KAR_SCRIPT := preload("res://scripts/weapons/kar.gd")
...
const KAR_SHOT_SFX := preload("res://assets/sounds/sfx/guns/kar98/kar98_shoot.wav")
...
const RESPAWN_SFX := preload("res://assets/sounds/sfx/general/levelup_bell.wav")
const RESPAWN_RPC_SENTINEL := Vector2(98765.0, -98765.0)

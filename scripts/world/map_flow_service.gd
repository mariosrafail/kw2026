...
func decode_create_lobby_payload(
	...
	if normalized_character_part != "erebus" and normalized_character_part != "tasko" and normalized_character_part != "juice" and normalized_character_part != "madam" and normalized_character_part != "celler" and normalized_character_part != "kotro" and normalized_character_part != "nova" and normalized_character_part != "hindi" and normalized_character_part != "loker" and normalized_character_part != "gan" and normalized_character_part != "veila" and normalized_character_part != "krog" and normalized_character_part != "aevilok" and normalized_character_part != "franky" and normalized_character_part != "varn" and normalized_character_part != "lalou" and normalized_character_part != "m4" and normalized_character_part != "rp":

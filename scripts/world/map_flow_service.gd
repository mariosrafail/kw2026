...
func encode_create_lobby_payload(
	...
	if normalized_character != "erebus" and normalized_character != "tasko" and normalized_character != "juice" and normalized_character != "madam" and normalized_character != "celler" and normalized_character != "kotro" and normalized_character != "nova" and normalized_character != "hindi" and normalized_character != "loker":
...
func decode_create_lobby_payload(
	...
	if normalized_character_part != "erebus" and normalized_character_part != "tasko" and normalized_character_part != "juice" and normalized_character_part != "madam" and normalized_character_part != "celler" and normalized_character_part != "kotro" and normalized_character_part != "nova" and normalized_character_part != "hindi" and normalized_character_part != "loker":
